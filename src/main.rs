...
use bevy::math::Vec2;
use bevy::prelude::{App, BuildChildren, Camera2dBundle, Commands, default, IntoSystemConfigs, PluginGroup, Query, Res, Startup, Time, Update, Window};
use bevy::time::{Fixed};
...
fn main() {
    App::new()
        ...
        .add_systems(Update, snake::change_direction_system)
        .run();
}
